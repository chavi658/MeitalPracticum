...
namespace Practicum.API.Controllers
{
    ...
    public class EmployeeController : ControllerBase
    {
        ...
        {
            var employeeToAdd = new Employee { FirstName = employee.FirstName, LastName = employee.LastName, TZ = employee.TZ, DateOfBirth = employee.DateOfBirth, DateOfStart = employee.DateOfStart, Gender = employee.Gender,  Password = employee.Password,status=employee.status };
